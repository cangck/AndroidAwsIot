...
public class ArmsUtils {
    ...
    public static void putStringToSp(Context context, String key, String value) {
        ...
        appComponent.sharedPreferences().edit().putString(key, value).commit();
    }
    ...
    public static String getStringToSp(Context context, String key) {
        ...
        Preconditions.checkNotNull(key);
        AppComponent appComponent = obtainAppComponentFromContext(context);
        return appComponent.sharedPreferences().getString(key, "");
    }
     ...
     * @param key
     */
    public static void removeStringToSp(Context context, String key) {
        Preconditions.checkNotNull(context, "Context is null");
        Preconditions.checkNotNull(key);
        AppComponent appComponent = obtainAppComponentFromContext(context);
